...
namespace PixCharge.Infrastructure.Migrations_MsSqlServer.Migrations
{
    ...
    [Migration("20240328214448_Fix-Relations-Flat-With_Customer")]
    partial class FixRelationsFlatWith_Customer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerFlat", b =>
                {
                    ...
                    b.HasKey("CustomersId", "FlatsId");

                    b.HasIndex("FlatsId");

                    b.ToTable("CustomerFlat");
                });
            ...
            modelBuilder.Entity("CustomerFlat", b =>
                {
                    b.HasOne("PixCharge.Domain.Account.Aggregates.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PixCharge.Domain.Account.Aggregates.Flat", null)
                        .WithMany()
